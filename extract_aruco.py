...
if __name__ == "__main__":
  arg_parser: argparse.ArgumentParser = argparse.ArgumentParser(
      prog='ArucoExtractor',
      description="""
            Goes through video specified by --input-file argument, extracts aruco markers
            and saves those information to a json file specified by --output-file parameter"""
  )
